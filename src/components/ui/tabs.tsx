  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-background dark:data-[state=active]:border-input dark:data-[state=active]:bg-input/30 data-[state=active]:text-accent-foreground data-[state=active]:font-semibold",
