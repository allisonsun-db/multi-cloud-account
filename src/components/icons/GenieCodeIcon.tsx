...
export interface GenieCodeIconProps extends React.SVGProps<SVGSVGElement> {
...
export const GenieCodeIcon = forwardRef<SVGSVGElement, GenieCodeIconProps>(
...
GenieCodeIcon.displayName = "GenieCodeIcon"
